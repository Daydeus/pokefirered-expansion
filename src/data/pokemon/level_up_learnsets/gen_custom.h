...
static const struct LevelUpMove sMetapodLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_BIDE),                   // HARDEN -> BIDE
...
static const struct LevelUpMove sButterfreeLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_EXTRASENSORY),           // New relearner move
    LEVEL_UP_MOVE( 1, MOVE_AIR_SLASH),              // New relearner move
    LEVEL_UP_MOVE( 1, MOVE_STRING_SHOT),
    LEVEL_UP_MOVE( 4, MOVE_TACKLE),
    LEVEL_UP_MOVE( 7, MOVE_ABSORB),
    LEVEL_UP_MOVE(10, MOVE_INFESTATION),
    ...
    LEVEL_UP_MOVE(25, MOVE_SILVER_WIND),            // SUPERSONIC -> SILVER_WIND
    LEVEL_UP_MOVE(27, MOVE_WHIRLWIND),
    LEVEL_UP_MOVE(31, MOVE_PSYBEAM),
    LEVEL_UP_MOVE(33, MOVE_SAFEGUARD),              // SILVER_WIND -> SAFEGUARD
    LEVEL_UP_MOVE(37, MOVE_TAILWIND),
    LEVEL_UP_MOVE(39, MOVE_RAGE_POWDER),
    LEVEL_UP_MOVE(43, MOVE_MAGIC_POWDER),           // SAFEGUARD -> MAGIC_POWDER
...
static const struct LevelUpMove sBeedrillLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_FELL_STINGER),           // FURY_ATTACK -> FELL_STINGER
    LEVEL_UP_MOVE( 1, MOVE_NEEDLE_ARM),             // New relearner move
    LEVEL_UP_MOVE( 1, MOVE_CROSS_POISON),           // New relearner move
    LEVEL_UP_MOVE( 1, MOVE_STRING_SHOT),
    LEVEL_UP_MOVE( 4, MOVE_POISON_STING),
    LEVEL_UP_MOVE( 7, MOVE_PECK),
    LEVEL_UP_MOVE(10, MOVE_INFESTATION),
    LEVEL_UP_MOVE(13, MOVE_RAGE),                   // FOCUS_ENERGY -> RAGE
    LEVEL_UP_MOVE(16, MOVE_FURY_ATTACK),            // TWINEEDLE -> FURY_ATTACK
    LEVEL_UP_MOVE(19, MOVE_LASER_FOCUS),            // RAGE -> LASER_FOCUS
    LEVEL_UP_MOVE(22, MOVE_ASSURANCE),              // PURSUIT -> ASSURANCE
    LEVEL_UP_MOVE(25, MOVE_VENOSHOCK),              // TOXIC_SPIKES -> VENOSHOCK
    LEVEL_UP_MOVE(28, MOVE_PIN_MISSILE),
    LEVEL_UP_MOVE(31, MOVE_AGILITY),
    LEVEL_UP_MOVE(34, MOVE_DRILL_PECK),             // ASSURANCE -> DRILL_PECK
    LEVEL_UP_MOVE(37, MOVE_POISON_JAB),
    LEVEL_UP_MOVE(40, MOVE_TWINEEDLE),              // ENDEAVOR -> TWINEEDLE
    LEVEL_UP_MOVE(45, MOVE_OUTRAGE),                // FELL_STINGER -> OUTRAGE
    LEVEL_UP_END
};
...
static const struct LevelUpMove sSpearowLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(13, MOVE_PURSUIT),
    LEVEL_UP_MOVE(17, MOVE_WING_ATTACK),            // AERIAL_ACE -> WING_ATTACK
    LEVEL_UP_MOVE(21, MOVE_MIRROR_MOVE),
    LEVEL_UP_MOVE(25, MOVE_LOW_SWEEP),              // AGILITY -> LOW_SWEEP
    LEVEL_UP_MOVE(29, MOVE_ASSURANCE),
    LEVEL_UP_MOVE(33, MOVE_ROOST),
    LEVEL_UP_MOVE(37, MOVE_DRILL_PECK),
    LEVEL_UP_MOVE(41, MOVE_CROSS_CHOP),             // New STAB move
    LEVEL_UP_END
};
...
static const struct LevelUpMove sFearowLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(29, MOVE_LOW_SWEEP),              // AGILITY -> LOW_SWEEP
    LEVEL_UP_MOVE(35, MOVE_ASSURANCE),
    LEVEL_UP_MOVE(41, MOVE_ROOST),
    LEVEL_UP_MOVE(47, MOVE_DRILL_PECK),
    LEVEL_UP_MOVE(53, MOVE_CROSS_CHOP),             // DRILL_RUN -> CROSS_CHOP
    LEVEL_UP_END
};
...
static const struct LevelUpMove sPinsirLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_CLOSE_COMBAT),
    LEVEL_UP_MOVE( 1, MOVE_BIND),
    LEVEL_UP_MOVE( 1, MOVE_CONSTRICT),              // VISE_GRIP -> CONSTRICT
    LEVEL_UP_MOVE( 1, MOVE_FOCUS_ENERGY),
    LEVEL_UP_MOVE( 1, MOVE_HARDEN),
    LEVEL_UP_MOVE( 4, MOVE_SEISMIC_TOSS),           // BIND -> SEISMIC_TOSS
    LEVEL_UP_MOVE( 8, MOVE_SAND_TOMB),              // SEISMIC_TOSS -> SAND_TOMB
    LEVEL_UP_MOVE(11, MOVE_FURY_CUTTER),            // HARDEN -> FURY_CUTTER
    LEVEL_UP_MOVE(15, MOVE_VITAL_THROW),            // REVENGE -> VITAL_THROW
    LEVEL_UP_MOVE(18, MOVE_SAND_ATTACK),            // VITAL_THROW -> SAND_ATTACK
    LEVEL_UP_MOVE(22, MOVE_POUNCE),                 // DOUBLE_HIT -> POUNCE
    LEVEL_UP_MOVE(26, MOVE_BULLDOZE),               // BRICK_BREAK -> BULLDOZE
    LEVEL_UP_MOVE(29, MOVE_SUBMISSION),
    LEVEL_UP_MOVE(33, MOVE_THRASH),                 // X_SCISSOR -> THRASH
    LEVEL_UP_MOVE(36, MOVE_DRILL_RUN),              // STORM_THROW -> DRILL_RUN
    LEVEL_UP_MOVE(40, MOVE_SWORDS_DANCE),
    LEVEL_UP_MOVE(43, MOVE_LUNGE),                  // THRASH -> LUNGE
    LEVEL_UP_MOVE(47, MOVE_SUPERPOWER),
    LEVEL_UP_MOVE(50, MOVE_HEADLONG_RUSH),          // GUILLOTINE -> HEADLONG_RUSH
    LEVEL_UP_END
};
