...
const struct SpeciesInfo gSpeciesInfoGen1[] =
{
    ...
    [SPECIES_METAPOD] =
    {
        ...
        .baseDefense   = 55,
        .baseSpeed     = 30,
        .baseSpAttack  = 50, // 25 -> 50
        .baseSpDefense = 75, // 25 -> 75
        .types = MON_TYPES(TYPE_BUG),
        .catchRate = 120,
        .expYield = 72,
        .evYield_Defense = 2,
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SHELL_ARMOR, ABILITY_SHED_SKIN, ABILITY_STURDY },
        .bodyColor = BODY_COLOR_GREEN,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 15, SPECIES_BUTTERFREE}), // EVO_LEVEL 10 -> EVO_LEVEL 15
    },
    ...
    [SPECIES_BUTTERFREE] =
    {
        ...
        .baseSpDefense = 130, // 80 -> 130
        .types = MON_TYPES(TYPE_BUG, TYPE_PSYCHIC), // FLYING -> PSYCHIC
        .catchRate = 45,
    ...
    [SPECIES_KAKUNA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 15, SPECIES_BEEDRILL}), // EVO_LEVEL 10 -> EVO_LEVEL 15
    },
...
#define PIDGEOT_SPEED (P_UPDATED_STATS >= GEN_6 ? 101 : 91)
    ...
    [SPECIES_SPEAROW] =
    {
        ...
        .baseSpAttack  = 31,
        .baseSpDefense = 31,
        .types = MON_TYPES(TYPE_FIGHTING, TYPE_FLYING), // NORMAL -> FIGHTING
        .catchRate = 255,
...
#define EXEGGUTOR_SP_DEF (P_UPDATED_STATS >= GEN_7 ? 75 : 65)
    ...
    [SPECIES_PINSIR] =
    {
        ...
        .baseSpAttack  = 55,
        .baseSpDefense = 70,
        .types = MON_TYPES(TYPE_BUG, TYPE_GROUND), // Add the GROUND type.
        .catchRate = 45,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 175 : 200,
        .evYield_Attack = 2,
        .genderRatio = PERCENT_FEMALE(50),
